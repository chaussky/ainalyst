...
**MCP tools**, 22 servers with 113 tools that perform specific analytical operations: building stakeholder registries, analyzing interview transcripts, creating traceability matrices, assessing risks, drafting requirements specifications.
