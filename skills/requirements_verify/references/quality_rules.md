...
**Замечание:** списки-детекторы ниже работают по РУССКИМ сигнальным словам и воспроизведены здесь ровно так, как они реализованы в `requirements_verify_mcp.py`. Не меняйте их при правке этого документа: списки этой ветки намеренно отличаются от английских — русскому нужно несколько форм слова там, где английскому хватает одной.
