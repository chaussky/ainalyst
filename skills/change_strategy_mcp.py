...
def compare_strategy_options(
    ...
    Args:
        ...
        scores_json: JSON matrix of 1-5 scores per criterion.
            ...
            Example: '{"OPT-001": {"alignment_to_goals": 4, "risk_mitigation": 3, "cost": 3, "time_to_value": 4, "org_readiness_fit": 3, "feasibility": 4}}'
        ...
        weights_json: Optional — override the default criteria weights.
            ...
            Example: '{"alignment_to_goals": 30, "risk_mitigation": 20, "cost": 15, "time_to_value": 15, "org_readiness_fit": 10, "feasibility": 10}'
        custom_criteria_json: Optional — add custom criteria with weights.
            Format: {"regulatory_compliance": {"weight": 15, "description": "..."}}
            A custom criterion ADDS its weight, so reduce the standard ones in
            weights_json by the same amount — the total must stay 100.
            Example: '{"regulatory_compliance": {"weight": 15, "description": "Compliance with regulator requirements"}}'
    """
