...
### Удалено
- `migrate_solution_scope.py`. Скрипт чинил графы требований, написанные до того, как глава 6.4 перестала помечать область решения литералом `solution` из словаря требований 5.1. Это переименование старше первого публичного релиза, поэтому ни одна опубликованная версия формат, который он чинил, никогда не писала.
